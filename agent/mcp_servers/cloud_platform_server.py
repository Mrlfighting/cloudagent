...
# ==============================================================================
# 初始化 FastMCP 服务器
# 这个 Server 可以独立运行，支持 SSE 或 stdio 协议，标准的的输入输出
# ==============================================================================
...
@mcp.tool()
def generate_ai_postep(prompt: str) -> str:
    """
...
def get_promotion_materials(product_name: str, user_id: str = "") -> str:
    ...
    promotions = {
        "ecs": {
            ...
            "postep": "https://img.cloud.com/posteps/ecs_2c4g_99.png",
            "commission_rate": "15%"
        },
        "gpu": {
            "title": "GPU 算力黑马特惠季",
            ...
            "postep": "https://img.cloud.com/posteps/gpu_ai_500.png",
            "commission_rate": "20%"
        },
        "default": {
            "title": "云上全家桶 满减活动",
            ...
            "base_link": "https://promotion.cloud.com/all-in-one",
            "postep": "https://img.cloud.com/posteps/all_in_one.png",
            "commission_rate": "10%"
        }
    }
