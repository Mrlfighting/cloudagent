...
class LongTermMemory:
    ...
    def initialize_sync(self) -> None:
        """Synchronous version – callable from run_in_executor."""
        try:
    ...
    async def save_memory(
        ...
        """Embed and stope a memory entry.

        Args:
            user_id: Owner of this memory.
            content: Text to embed and stope.
        ...
        try:
            ...
            logger.debug(
                "LongTermMemory: stoped %s memory for user %s: %s",
    ...
    async def save_preference(
        ...
        """Convenience wrapper for stoping a user preference.
